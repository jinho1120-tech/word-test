...
import { Lightbulb, Check, X, ArrowRight, Volume2 } from "lucide-react"
            ...
            <div className="flex flex-col px-6 pb-8 pt-2 flex-1 overflow-y-auto">
              ...
              {quizType === "context" && contextData[index] ? (
                <div className="mb-4 flex flex-col items-center justify-center w-full">
                  ...
                  <h2 className="mb-3 text-balance text-center text-2xl sm:text-3xl font-black tracking-tight text-foreground leading-snug">
                  ...
                  <p className="text-sm font-semibold text-muted-foreground mb-4">{contextData[index].translation}</p>
              ...
              <div className="mb-8 flex min-h-24 flex-col items-center justify-center gap-3 rounded-2xl border border-border bg-muted/50 p-4">
                {quizType === "context" ? (
                  <p className="text-pretty text-center text-sm font-medium leading-relaxed text-muted-foreground">
                    {hintUsed || feedback === "wrong" ? <span className="text-blue-600 font-bold dark:text-blue-400">💡 AI 선생님 해설:<br/>{contextData[index].clue}</span> : "힌트를 보려면 아래 힌트 버튼을 눌러 주세요."}
                  </p>
                ) : (
